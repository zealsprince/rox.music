...
- UI: forty panel types, arranged by the user, duplicated with independent configs, and poppable into real OS windows.
- Themes: a "workspace" is one file carrying layout, palette and appearance together. Six ship in the box.
...
- [Workspaces](${url('/workspaces')}): the six shipped looks with screenshots.
